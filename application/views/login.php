            ...
            <div class="content top-10 bottom-20">
              <form class="" role="form" action="<?= base_url()?>Login/log" method="POST" name="loginform">
                ...
                <div class="input-style has-icon input-style-1 input-required">
                    ...
                    <input type="email" placeholder="Correo" name="email" value="kamerlingh96@outlook.es">
                </div>
                <div class="input-style has-icon input-style-1 input-required">
              ...
              <a href="<?= base_url()?>Register/transportista" class="button button-full button-m shadow-large button-round-small bg-green1-dark top-30 bottom-0">TRANSPORTISTA</a>
