                            ...
                            <div class="card-body">
                              <div class="table-responsive">
                                  <table id="demo-foo-addrow" class="table m-t-30 no-wrap table-hover contact-list" data-page-size="10">
                                      ...
                                      <tbody>
                                        <?php foreach ($listaDeClientes->result() as $cliente): ?>

                                          <tr>
                                            <td><?=$cliente->id_usuario?></td>
                                            <td>
                                              <a href="javascript:void(0)"><img src="<?=base_url()?>estilos/assets/images/users/1.jpg" alt="user" width="40" class="rounded-circle" /> <?=$cliente->nombre?></a>
                                            </td>
                                            ...
                                            <?php
                                            $fechaDeRegistroEspacio = explode(" ", $cliente->fecha_registro);
                                            $fechaDeRegistro = explode("-", $fechaDeRegistroEspacio[0]);
                                            $fechaDeRegistro[1] = obtenerFecha($fechaDeRegistro[1]);
                                             ?>
                                            <td><?=$fechaDeRegistro[2]?>-<?=$fechaDeRegistro[1]?>-<?=$fechaDeRegistro[0]?></td>
                                            <td>
