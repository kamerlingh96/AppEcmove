                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Transportistas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                  ...
                                  <table id="demo-foo-addrow" class="table m-t-30 no-wrap table-hover contact-list" data-page-size="10">
                                      ...
                                      <tbody>
                                        <?php foreach ($listaDeTransportistas->result() as $transportista): ?>
                                          ...
                                          <tr>
                                            <td><?=$transportista->id_user?></td>
                                            <td>
                                              <a href="javascript:void(0)"><img src="<?=base_url()?><?=$transportista->img_personal?>" alt="user" width="40" class="rounded-circle" /> <?=$transportista->nombre?></a>
                                            </td>
                                            <td><?=$transportista->curp?></td>
                                            <td><?=$transportista->correo?></td>
                                            <td><?=$transportista->tel?></td>
                                            <td>
                                              <span class="label label-<?php if($transportista->estado == "on"){echo "success";}elseif($transportista->estado == "off"){echo "inverse";}elseif ($transportista->estado == "bloqueado"){echo "danger";} ?>">
