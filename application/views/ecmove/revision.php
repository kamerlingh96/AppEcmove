...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Revisión a: <?= $revisionEmpresa->nombre_empresa ?></h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                    <li class="breadcrumb-item" aria-current="page">Revisión</li>
                                    <li class="breadcrumb-item active" aria-current="page"><?= $revisionEmpresa->id_usuario ?></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <div class="media">
                                  <img class="m-r-15 img-fluid w-25" src="<?= base_url() ?><?= $revisionEmpresa->logo ?>" alt="Generic placeholder image" width="">
                                  <div class="media-body">
                                    <div class="row">
                                      <div class="col-md-4">
                                        <h4>Empresa:</h4>
                                        <h4> <small><?= $revisionEmpresa->nombre_empresa ?></small></h4>
                                      </div>
                                      <div class="col-md-4">
                                        <h4>RFC:</h4>
                                        <h4> <small><?= $revisionEmpresa->rfc ?></small></h4>
                                      </div>
                                      <div class="col-md-4">
                                        <h4>Representante:</h4>
                                        <h4> <small><?= $revisionEmpresa->representante ?></small></h4>
                                      </div>
                                    </div>
                                    <div class="row m-t-15">
                                      <div class="col-md-3">
                                        <address>
                                            ...
                                            <br> <?= $revisionEmpresa->calle ?>, Col. <?= $revisionEmpresa->colonia ?>
                                            <br> <?= $revisionEmpresa->ciudad ?>, <?= $revisionEmpresa->estado_ubicacion ?>, <?= $revisionEmpresa->cp ?>
                                            <br>
                                            <abbr title="Telefono">Tel: </abbr><?= $revisionEmpresa->tel ?>
                                        </address>
                                        <address>
                                            <strong>Correo</strong>
                                            <br>
                                            <a href="mailto:#"><?= $revisionEmpresa->correo ?></a>
                                        </address>
                                      </div>
                                      <div class="col-md-9">
                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                        <div class="button-group text-right">
                                          ...
                                          <a href="<?= base_url() ?>Revision/esperar/<?= $revisionEmpresa->id_usuario ?>"><button type="button" class="btn waves-effect waves-light btn-warning">Esperar</button></a>
                                          <a href="<?= base_url() ?>Revision/rechazar/<?= $revisionEmpresa->id_usuario ?>"><button type="button" class="btn waves-effect waves-light btn-danger">Rechazar</button></a>
                                          <a href="<?= base_url() ?>Revision/aprovar/<?= $revisionEmpresa->id_usuario ?>"><button type="button" class="btn waves-effect waves-light btn-success" >Aprovar</button></a>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
    ...
    function setMapa (coords)
    {
          ...
          {
            zoom: 13,
            center:new google.maps.LatLng(18.65762988745249,-91.8241836003906),
          ...
          marker = new google.maps.Marker({
            ...
            position: new google.maps.LatLng(18.65762988745249,-91.8241836003906),
