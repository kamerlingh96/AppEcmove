                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                      <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#cotizacion" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Cotización</span></a> </li>
                                      ...
                                      <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#pago" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Pago</span></a> </li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane active" id="cotizacion" role="tabpanel">
                                            <div class="p-20">
                                        ...
                                        <div class="tab-pane p-20" id="pago" role="tabpanel">
                                          <?php foreach ($listaDeEmbarque->result() as $embarque): ?>
                                            <?php foreach ($listaDeRemitenteDestinatario->result() as $remitenteDestinatario): ?>
                                              <?php foreach ($listaDeInicioFin->result() as $inicioFin): ?>
                                                <?php foreach ($listaDePaquete->result() as $paquete): ?>
                                                  <?php if ($embarque->id == $folioCotizacion &&
                                                            ...
                                                            <div class="row">
                                                              <div class="col-md-6">
                                                                ...
                                                                <?php if ($embarque->tipoPago == "PayPal"): ?>
