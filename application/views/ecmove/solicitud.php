            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <h4 class="card-title">Por revisar</h4>
                                        ...
                                        foreach ($solicitudesEmpresas->result() as $fila) {
                                         ...
                                         ?>
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="<?= base_url()?>Revision/revisionSolicitud/<?= $fila->id_usuario ?>"><img src="<?= $fila->logo ?>" alt="user" width="40" class="rounded-circle" /> <?= $fila->nombre_empresa ?></a>
                                              </td>
                                              <td><?= $fila->rfc ?></td>
                                              <td><?= $fila->correo ?></td>
                                              <td><?= $fila->tel ?></td>
                                              <td><span class="label label-danger"><?= $fila->estado ?></span> </td>
                                              <td>
                                                <?php
                                                $porciones = explode(" ", $fila->fecha_registro);
                                                echo $porciones[0];
                                                 ?>
                                              </td>
                                          </tr>
