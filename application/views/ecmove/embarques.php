...
<head>
    ...
    <!-- chartist CSS -->
    <link href="<?= base_url()?>estilos/assets/libs/chartist/dist/chartist.min.css" rel="stylesheet">
    <link href="<?= base_url()?>estilos/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css" rel="stylesheet">
    <!--c3 CSS -->
    <link href="<?= base_url()?>estilos/assets/extra-libs/c3/c3.min.css" rel="stylesheet">

    <link href="<?= base_url()?>estilos/assets/extra-libs/datatables.net-bs4/css/dataTables.bootstrap4.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-8">
                                                <h4 class="card-title">Ordenes de Embarques</h4>
                                                <h5 class="card-subtitle m-b-0">Mes Octubre</h5>
                                                <div class="row m-t-20">
                                                    <div class="col-4 border-right">
                                                        <i class="fa fa-circle text-cyan"></i>
                                                        <h3 class="m-b-0 font-medium">5489</h3>
                                                        <span>Embarques Completados</span>
                                                    </div>
                                                    <div class="col-4 border-right">
                                                        <i class="fa fa-circle text-orange"></i>
                                                        <h3 class="m-b-0 font-medium">954</h3>
                                                        <span>Embarques en Proceso</span>
                                                    </div>
                                                    <div class="col-4">
                                      ...
                                      <tbody>
                                        ...
                                        if (!empty($listaDeEmbarque)) {
                                          foreach ($listaDeEmbarque->result() as $embarque) {
                                            if ($embarque->estadoDeEmbarque == "Revisión") {
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                <td><?php echo "$fechaDeFacturacion[2] $mesFacturacion $fechaDeFacturacion[0]"; ?></td>
                                                <td><?php echo "$fechaDeVencimiento[2] $mesVencimiento $fechaDeVencimiento[0]"; ?></td>
                                                <td>$<?=number_format($embarque->totalFacturacion)?></td>
                                                <td><?=$embarque->estadoDeEmbarque?></td>
                                                <td>
                                                  <div class="btn-group">
                                                    <a href="<?=base_url()?>PanelEcmove/Embarques/Revision/<?=$embarque->id?>"><button type="button" class="btn waves-effect waves-light btn-warning">Revisar</button></a>
                                                  </div>
                                                </td>
                                            </tr>
                                            <?php
                                          ...
                                          foreach ($listaDeEmbarque->result() as $embarque) {
                                            if ($embarque->estadoDeEmbarque == "Pendiente") {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  <div class="btn-group">
                                                    <a href="<?=base_url()?>PanelEcmove/Embarques/Ver/<?=$embarque->id?>"><button type="button" class="btn waves-effect waves-light btn-dark">Ver</button></a>
                                                  </div>
                                                </td>
                                            </tr>
                                            <?php
                                          ...
                                          foreach ($listaDeEmbarque->result() as $embarque) {
                                            if ($embarque->estadoDeEmbarque == "Completado") {
    ...
    <script src="<?= base_url()?>estilos/assets/libs/chartist/dist/chartist.min.js"></script>
    <script src="<?= base_url()?>estilos/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>

    <!--c3 JavaScript -->
    <script src="<?= base_url()?>estilos/assets/extra-libs/c3/d3.min.js"></script>
    <script src="<?= base_url()?>estilos/assets/extra-libs/c3/c3.min.js"></script>
    <script src="<?= base_url()?>estilos/assets/libs/chart.js/dist/chart.min.js"></script>
    <script src="<?= base_url()?>estilos/sistema/js/embarquesEcmove.js"></script>

    <script src="<?= base_url()?>estilos/assets/extra-libs/DataTables/datatables.min.js"></script><!-- start - This is for export functionality only -->
    <script>
    //=============================================//
    //    File export                              //
    //=============================================//
