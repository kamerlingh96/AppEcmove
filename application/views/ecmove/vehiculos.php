...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                          <div class="card-body">
                            ...
                            <button type="button" class="btn btn-info btn-rounded m-t-10 mb-2 float-right" data-toggle="modal" data-target="#add-contact">Agregar Nuevo Vehiculo</button>
                            ...
                            <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <form class="" role="form" action="<?= base_url()?>Vehiculos/agregarVehiculo" method="POST" id="agregarVehiculo">
                                    <div class="modal-header">
                                      <h4 class="modal-title" id="myModalLabel">Agregar Nuevo Vehiculo</h4>
                                    ...
                                    <div class="modal-body">
                                      <from class="form-horizontal form-material">
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-12 m-b-20">
                                            <input type="text" class="form-control" placeholder="direccion" value="" id="direccionURL" name="url">
                                          </div>
                                          <div class="col-md-12 m-b-20" style="text-align:center;">
                                            <img src="<?= base_url()?>estilos/assets/images/users/1.jpg" alt="user" width="150" onclick="cambiar()" id="imgSelecionada" style="display:none;">
                                          </div>
                                          <div class="col-md-12 m-b-20" style="text-align:center;">
                                            <button type="button" class="btn btn-rounded m-t-10 mb-2 float-center" data-toggle="modal" data-target="#agregarMedia">SELECCIONAR MEDIO...</button>
                                          </div>
                                          <div class="col-md-12 m-b-20">
                                          </div>
                                        </div>
                            ...
                            <div id="agregarMedia" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                              <div class="modal-dialog" style="max-width:800px;">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel">Seleccionar Medio</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                  </div>
                                  <div class="modal-body">
                                    <from class="form-horizontal form-material">
                                      <div class="form-group">
                                        <div class="row">
                                          <div class="col-md-8 m-b-20" style="height:430px;overflow: scroll;" id="imgMedia">
                                            <?php foreach ($list_galeria->result() as $fila) {
                                              ?>
                                              <div style="margin:5px;float:left;">
                                                <img src="<?= base_url()?><?= $fila->direccion?>" alt="user" width="150" height="120" onclick="cambiar()" id="img<?php echo $fila->id;?>" title="<?=$fila->titulo?>">
                                              </div>
                                              <?php
                                              }
                                            ?>
                                          ...
                                          <div class="col-md-4 m-b-20">
                                            <div class="col-md-12" style="height:220px;">
                                                <img src="<?= base_url()?>estilos/assets/images/users/4.jpg" alt="user" width="100%" height="100%" class="rounded-circle" id="imagenSelec">
                                            </div>
                                            <div class="col-md-12 m-t-20">
                                              <input type="text" class="form-control" placeholder="Título" disabled id="tituloImagen">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                              ...
                              <table id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list footable footable-5 footable-paging footable-paging-center breakpoint-md" data-paging="true" data-paging-size="7" style="">
                                ...
                                <tbody>
                                  ...
                                  foreach ($list_vehiculos->result() as $fila) {
                                    ?>
                                    <tr>
                                      <td class="footable-first-visible" style="display: table-cell;"><?= $fila->id?></td>
                                      <td style="display: table-cell;">
                                        <a href="javascript:void(0)"><img src="<?= base_url()?><?= $fila->direccion ?>" alt="user"  height="40" > <?= $fila->vehiculo ?></a>
                                      </td>
                                      <td style="display: table-cell;">Torton</td>
                                    </tr>
                                    <?php
                                  }
    ...
    <script src="<?= base_url()?>estilos/sistema/js/agregarVehiculo.js"></script>
    ...
    ckEdiloop.addEventListener("click", function(el){
        ...
        document.getElementById('tituloImagen').value = thisTittle;
    ...
    function selecionarImg(){
      ...
      document.getElementById('direccionURL').value = imgSelecionada;
    }
