...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title"><?=$datosPerfil->nombre?></h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                    <li class="breadcrumb-item" aria-current="page">Mis Transportistas</li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" novalidate action="<?= base_url()?>MisTransportistas/actualizar/<?=$datosPerfil->id_user?>" method="post" enctype="multipart/form-data" id="transportistas">
                                <div class="media row">
                                  <div class="media col-md-3" style="height:300px;">
                                    <img class="m-r-15 img-fluid h-75 " src="<?= base_url() ?><?= $datosPerfil->img_personal ?>" alt="Generic placeholder image" >
                                  </div>
                                  <div class="col-md-9">
                                    <div class="form-group">
                                      <div class="row">
                                        <div class="col-md-12 m-b-20">
                                          <input type="text" class="form-control" placeholder="* Nombre Completo" name="nombre" required value="<?= $datosPerfil->nombre ?>">
                                      ...
                                      <div class="row">
                                        <div class="col-md-6 m-b-20">
                                          <input type="text" class="form-control" placeholder="Correo" name="correo" required value="<?= $datosPerfil->correo ?>">
                                          <div class="valid-feedback">
                                            ¡Bien!
                                          </div>
                                          <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 m-b-20">
                                          <input type="password" class="form-control" placeholder="Contraseña" name="pass" required value="<?= $datosPerfilUser->pass ?>">
                                          <div class="valid-feedback">
                                            ¡Bien!
                                          </div>
                                          <div class="invalid-feedback">
                                      ...
                                      <div class="row">
                                        <div class="col-md-6 m-b-20">
                                          <input type="text" class="form-control" placeholder="* Telefono" maxlength="10" name="tel" required value="<?= $datosPerfil->tel ?>">
                                          <div class="valid-feedback">
                                            ¡Bien!
                                          </div>
                                          <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 m-b-20">
                                          <input type="text" class="form-control" placeholder="CURP" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="18" name="curp" required value="<?= $datosPerfil->curp ?>">
                                          <div class="valid-feedback">
                                            ¡Bien!
                                          </div>
                                          <div class="invalid-feedback">
                                          ...
                                          <div class="form-group">
                                            <select class="form-control custom-select" required name="vehiculo">
                                              ...
                                              foreach ($vehiculos->result() as $value) {
                                                ?>
                                                <option value="<?=$value->id?>" <?php if($datosPerfil->id_vehiculo == $value->id){echo "selected";} ?>><?=$value->vehiculo?></option>
                                                <?php
                                              }
                                              ?>
                                            </select>
                                      ...
                                      <div class="col-md-12 m-b-20">
                                        <div class="fileupload btn btn-info btn-rounded waves-effect waves-light" style="width:100%;"><span><i class="ion-upload m-r-5"></i>Actualizar Foto</span>
                                ...
                                <div class="row">
                                  <div class="col-md-12 text-right">
                                    <button type="submit" class="btn btn-success btn-rounded" data-toggle="modal" data-target="#add-contact">Actualizar</button>
                                  </div>
                                </div>
                              </form>
                            </div>
    ...
    <script type="text/javascript">
      ...
      var id_user = "<?php echo $datosPerfil->id_user; ?>";
    </script>
    <!-- ============================================================== -->
    ...
    <script src="<?= base_url()?>estilos/sistema/js/actualizarTransportista.js"></script>
</body>
