    ...
    <div class="page-content header-clear-medium">
            ...
            <div class="content-boxed left-40 right-40">
                <div class="content top-10 bottom-10">
                  <form class="" role="form" action="<?= base_url()?>Register/cliente" method="POST" name="formulariocliente" id="cliente">
                    ...
                    <div class="bottom-20">
                        <a href="<?php echo base_url(); ?>Login" class="back-button center-text font-11 color-theme">¿Ya tienes una cuenta? Iniciar sesión.</a>
                    </div>
