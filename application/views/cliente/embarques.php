                        ...
                        <div class="card">
                            <div class="card-body">
                              <div class="button-group">
                                <a href="<?=base_url()?>PanelCliente/Embarques/agregar"><button type="button" class="btn waves-effect waves-light btn-rounded btn-success">Nuevo Viaje</button></a>
                              </div>
                                        ...
                                        if (!empty($listaDeEmbarque)) {
                                          foreach ($listaDeEmbarque->result() as $embarque) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                foreach ($listaDeRemitenteDestinatario->result() as $RemitenteDestinatario) {
                                                  if ($RemitenteDestinatario->id_embarque == $embarque->id) {
                                                    echo $RemitenteDestinatario->nombreFin;
                                                  }
                                                }
                                                 ?></td>
                                                <td>$<?=number_format($embarque->totalFacturacion)?></td>
                                                <td><?=$embarque->estadoFacturacion?></td>
                                                <td>
                                                  <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu animated slideInUp" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 35px, 0px);">
                                                      <a class="dropdown-item" href="<?=base_url()?>PanelCliente/Embarques/cotizacion/<?=$embarque->id?>"><i class="ti-eye"></i> Ver</a>
