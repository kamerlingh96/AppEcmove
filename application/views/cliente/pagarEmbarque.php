...
<head>
    ...
    <title>Pagar Embarque</title>
    <!-- Custom CSS -->
    <link href="<?= base_url()?>estilos/dist/css/style.min.css" rel="stylesheet">
    <link href="<?= base_url()?>estilos/sistema/css/dist/dropzone.css" rel="stylesheet">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Cotización #<?=$folioCotizacion?></h4>
                                                    ...
                                                    $paquete->id_embarque == $folioCotizacion): ?>
                                                      <div class="col-md-12">
                                                        <div class="text-center">
                                                          <h3>Total a pagar: $<?=number_format($embarque->totalFacturacion)?></h3>
                                                        </div>
                                                      </div>
                                          <div class="col-md-6 text-center align-middle ">
                                            <div class="" style="height:100%;" id="dropzone">
                                              <form action="<?=base_url()?>PanelCliente/Embarques/pagoComprobante/<?php echo $folioCotizacion;?>" method="post" class="dropzone needsclick" id="myawesomedropzone" enctype="multipart/form-data" >

                                                <div class="form-group">
                                                    <label>Subir Comprobante de pago</label>
                                                    <input type="file" class="form-control" name="dropzoneComprobante">
                                                </div>
                                                <button type="submit" name="button" id="enviarButton">Enviar Comprobante</button>
                                              </form>
                                            </div>
                                          </div>
                                          <div class="col-md-6 text-center align-middle">
                                            ...
                                            <script src="https://www.paypal.com/sdk/js?client-id=AX4qlAEfqJcUREJfm5kpTOaEqXA4X_hqwS2AC7c_NAZVSXIUYEFo92j1EN4d968-tqdAyCluZpgJkzKJ&currency=MXN"></script>
                                            ...
                                            paypal.Buttons({
                                                ...
                                                createOrder: function(data, actions) {
                                                    return actions.order.create({
                                                        purchase_units: [{
                                                            amount: {
                                                                value: '<?php echo $embarque->totalFacturacion ?>'
                                                            },
                                                            description: "Servicio de transporte: <?= $paquete->vehiculoSeleccionado?>.",
                                                            custom: "<?=$folioCotizacion?>"
                                                        }]
                                                    });
                                                },
                                                ...
                                                onApprove: function(data, actions) {
                                                    return actions.order.capture().then(function(details) {
                                                        ...
                                                        console.log(data);
                                                        window.location= `<?php echo base_url();?>PanelCliente/Embarques/pagoPaypal/<?php echo $folioCotizacion;?>/${data.orderID}/${data.payerID}`
                                                    });
                                                }
